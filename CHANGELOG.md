...
- [terminal] added linkification of `file://` URLs printed in the terminal, opening the referenced local file in the editor [#XXXXX](https://github.com/eclipse-theia/theia/pull/XXXXX)
