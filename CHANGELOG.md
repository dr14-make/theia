...
- [terminal] added linkification of `file://` URLs printed in the terminal, opening the referenced local file in the editor, including an optional `:line:column` suffix [#XXXXX](https://github.com/eclipse-theia/theia/pull/XXXXX)
